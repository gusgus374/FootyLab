...
with st.container():
        ...
        with col2:
             ...
             st.write("The secret is there is no secret. No hacks. No shortcuts. We must focus on fundamentals not fads.") 
             st.write("The best diet is the one you can stick to consitently. The best exercise program is the one you can stick to consistently. The best routine is the one you can stick to consistently.")
